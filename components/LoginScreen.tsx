...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-64 h-64 bg-violet-200 rounded-full blur-[80px] opacity-60 animate-pulse"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-64 h-64 bg-fuchsia-200 rounded-full blur-[80px] opacity-60 animate-pulse delay-500"></div>

      <div className="bg-white/80 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl max-w-md w-full border border-white/50 relative z-10 animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-center gap-2 py-2 bg-green-50 rounded-lg border border-green-100 animate-fade-in delay-200" style={{ animationFillMode: 'both' }}>
